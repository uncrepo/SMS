...
public class TeacherDAO {
    ...
    public Teacher getTeacherByUserId(String userId) {
        String query = "SELECT users.full_name, teachers.email,teachers.teacher_id, teachers.phone, teachers.guardian" +
    ...
    public static  ObservableList<Teacher> getAssignedTeachers() {
        String query = "  SELECT  " +
                "    Users.full_name, " +
    ...
    public static  ObservableList<Teacher> searchAssignedTeachersByName(String searchText, String grade, String section, String academicYear, String course) {
        ObservableList<Teacher> teachers = FXCollections.observableArrayList();
        String query = "  SELECT  " +
                "    Users.full_name, " +
                "    assign_teacher_class.assign_teacher_id, " +
    ...
    public static void addTeacher(String fullName, String email, String username, String password, String phone, String guardian) {
        String userQuery = "INSERT INTO Users (full_name, username, password, role) VALUES (?, ?, ?, 'TEACHER')";
        String teacherQuery = "INSERT INTO Teachers (user_id, phone, guardian, email) VALUES (?, ?, ?, ?)";
        ...
        try (Connection conn = Model.getInstance().getDbConnection().getConnection();
            ...
            try (ResultSet generatedKeys = userStmt.getGeneratedKeys()) {
                if (generatedKeys.next()) {
                    ...
                    teacherStmt.setString(2, phone);
                    teacherStmt.setString(3, guardian);
